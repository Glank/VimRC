...
autocmd FileType py,python set ts=2 sts=2 sw=2 expandtab
autocmd FileType htm,html set ts=2 sts=2 sw=2 expandtab
autocmd FileType javascript,js,mjs,json set ts=2 sts=2 sw=2 expandtab
autocmd FileType tex set ts=2 sts=2 sw=2 expandtab
